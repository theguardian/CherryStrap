...
try:
    ...
    _EVP = None
# pkg
from lib.passlib.exc import lib.passlibRuntimeWarning, ExpectedTypeError
from lib.passlib.utils import join_bytes, to_native_str, bytes_to_int, int_to_bytes, join_byte_values
from lib.passlib.utils.compat import b, bytes, BytesIO, irange, callable, int_types
# local
__all__ = [
    "get_prf",
    "pbkdf1",
