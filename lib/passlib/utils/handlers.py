...
from lib.passlib.utils import classproperty, consteq, getrandstr, getrandbytes,\
                          BASE64_CHARS, HASH64_CHARS, rng, to_native_str, \
                          is_crypt_handler, to_unicode, \
                          MAX_PASSWORD_SIZE
from lib.passlib.utils.compat import b, join_byte_values, bytes, irange, u, \
...
#    relaxed = False # when _norm_xxx() funcs should be strict about inputs
    ...
    def _sanitize(value, char=u("*")):
        ...
        if isinstance(value, bytes):
            from lib.passlib.utils import ab64_encode
