...
# site
# pkg
from lib.passlib.apps import django10_context, django14_context, django16_context
from lib.passlib.context import CryptContext
import lib.passlib.exc as exc
from lib.passlib.utils.compat import iteritems, unicode, get_method_function, u, PY3
from lib.passlib.utils import memoized_property
from lib.passlib.registry import get_crypt_handler
# tests
from lib.passlib.tests.utils import TestCase, skipUnless, catch_warnings, TEST_MODE, has_active_backend
...
#=============================================================================
from lib.passlib.ext.django.utils import DJANGO_VERSION
...
class DjangoBehaviorTest(_ExtensionTest):
    ...
    def test_config(self):
        ...
        if has_django14:
            from lib.passlib.ext.django.utils import hasher_to_passlib_name, passlib_to_hasher_name
        ...
        if patched:
            ...
            from lib.passlib.ext.django.models import password_context
...
class DjangoExtensionTest(_ExtensionTest):
    ...
    def test_01_overwrite_detection(self):
        ...
        from lib.passlib.ext.django.models import _manager
        def dummy():
            pass
...
# to ensure we mimic their behavior.
if test_hashers_mod:
    from lib.passlib.tests.utils import patchAttr
