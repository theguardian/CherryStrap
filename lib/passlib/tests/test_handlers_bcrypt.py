...
class _bcrypt_test(HandlerCase):
    ...
    def os_supports_ident(self, hash):
        ...
        from lib.passlib.handlers.bcrypt import IDENT_2X, IDENT_2Y
    ...
    def fuzz_verifier_bcrypt(self):
        ...
        from lib.passlib.handlers.bcrypt import IDENT_2, IDENT_2A, IDENT_2B, IDENT_2X, IDENT_2Y, _detect_pybcrypt
        from lib.passlib.utils import to_native_str, to_bytes
        try:
            import bcrypt
        except ImportError:
            return
    ...
    def fuzz_verifier_bcryptor(self):
        ...
        from lib.passlib.handlers.bcrypt import IDENT_2, IDENT_2A, IDENT_2Y, IDENT_2B
        from lib.passlib.utils import to_native_str
        try:
