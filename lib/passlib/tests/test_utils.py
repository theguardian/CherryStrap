...
class MiscTest(TestCase):
    ...
    def test_classproperty(self):
        from lib.passlib.utils import classproperty
    ...
    def test_deprecated_function(self):
        from lib.passlib.utils import deprecated_function
...
class Base64EngineTest(TestCase):
    ...
    def test_constructor(self):
        from lib.passlib.utils import Base64Engine, AB64_CHARS
    ...
    def test_ab64(self):
        from lib.passlib.utils import ab64_decode
...
class _Base64Test(TestCase):
    ...
    def test_repair_unused(self):
        ...
        from lib.passlib.utils import rng, getrandstr
        engine = self.engine
...
from lib.passlib.utils import h64, h64big
