...
# pkg
# module
from lib.passlib.utils.compat import b, bytes, bascii_to_str, irange, PY2, PY3, u, \
                                 unicode, join_bytes, PYPY, JYTHON
from lib.passlib.tests.utils import TestCase, TEST_MODE, catch_warnings, skipUnless, skipIf
...
class DesTest(TestCase):
    ...
    def test_01_expand(self):
        """test expand_des_key()"""
        from lib.passlib.utils.des import expand_des_key, shrink_des_key, \
    ...
    def test_02_shrink(self):
        ...
        from lib.passlib.utils.des import expand_des_key, shrink_des_key, \
                                      INT_64_MASK
        from lib.passlib.utils import random, getrandbytes
    ...
    def _random_parity(self, key):
        ...
        from lib.passlib.utils.des import _KDATA_MASK, _KPARITY_MASK, INT_64_MASK
        from lib.passlib.utils import rng
    ...
    def test_04_encrypt_ints(self):
        ...
        from lib.passlib.utils.des import des_encrypt_int_block
...
#=============================================================================
from lib.passlib.utils.md4 import _has_native_md4
...
class _MD4_Test(TestCase):
    ...
    def setUp(self):
        ...
        import lib.passlib.utils.md4 as mod
...
class _Pbkdf2_Test(TestCase):
    ...
    def setUp(self):
        ...
        import lib.passlib.utils.pbkdf2 as mod
