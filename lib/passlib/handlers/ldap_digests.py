...
from lib.passlib.utils import to_native_str, unix_crypt_schemes, \
                          classproperty, to_unicode
from lib.passlib.utils.compat import b, bytes, uascii_to_str, unicode, u
...
##        from lib.passlib.hosts import host_context
