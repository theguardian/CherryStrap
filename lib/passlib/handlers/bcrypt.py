...
try:
    ...
    _bcryptor = None
# pkg
from lib.passlib.exc import lib.passlibHashWarning, PasslibSecurityWarning, PasslibSecurityError
from lib.passlib.utils import bcrypt64, safe_crypt, repeat_string, to_bytes, \
                          classproperty, rng, getrandstr, test_crypt, to_unicode
from lib.passlib.utils.compat import bytes, b, u, uascii_to_str, unicode, str_to_uascii
...
def _load_builtin():
    ...
    if _builtin_bcrypt is None:
        from lib.passlib.utils._blowfish import raw_bcrypt as _builtin_bcrypt
