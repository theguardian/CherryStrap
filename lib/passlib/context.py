...
# site
# pkg
from lib.passlib.exc import lib.passlibConfigWarning, ExpectedStringError, ExpectedTypeError
from lib.passlib.registry import get_crypt_handler, _validate_handler_name
from lib.passlib.utils import rng, tick, to_bytes, deprecated_method, \
                          to_unicode, splitcomma
from lib.passlib.utils.compat import bytes, iteritems, num_types, \
...
class CryptContext(object):
    ...
    def to_dict(self, resolve=False):
        ...
        As an example::
            ...
            >>> from lib.passlib.apps import ldap_nocrypt_context
