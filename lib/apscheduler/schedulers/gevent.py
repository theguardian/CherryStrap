...
from lib.apscheduler.schedulers.blocking import BlockingScheduler
from lib.apscheduler.schedulers.base import BaseScheduler
...
class GeventScheduler(BlockingScheduler):
    ...
    def _create_default_executor(self):
        from lib.apscheduler.executors.gevent import GeventExecutor
